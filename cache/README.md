...
1. [Обычный LRU-кэш](#роль-обычного-lru-кэша) (memcache-like)
2. [Кэш с базой данных MySQL](#роль-кэша-с-базой-данных-mysql)
3. [Кэш с базой данных Vinyl](#роль-кэша-с-базой-данных-vinyl)
